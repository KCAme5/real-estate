...
class ConversationByAgentView(generics.CreateAPIView):
    """
    Get or create conversation with a specific agent.
    - If existing conversation with this agent exists, return it
