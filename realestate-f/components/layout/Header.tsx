  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6">
        ...
        {/* Mobile Menu */}
        <div
          className={`lg:hidden fixed inset-x-0 top-16 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 shadow-2xl transition-all duration-300 ease-in-out ${
            mobileMenuOpen
