                ...
                <div className="flex items-center justify-between h-20 lg:h-24">
                    ...
                    <Link href="/" className="flex items-center gap-3 group">
                        ...
                        <div className="hidden sm:block">
                            <div className="text-xl lg:text-2xl font-bold text-gray-900 dark:text-white transition-colors group-hover:text-blue-600 dark:group-hover:text-blue-400 leading-none">
                                KenyaPrime
                            </div>
                            <div className="text-sm text-blue-600 dark:text-blue-400 font-medium tracking-wide">
                                Properties
                            </div>
                        </div>
                    </Link>
                                    ...
                                    return (
                                        <div key={link.name} className="flex flex-col">
                                            ...
                                            {mobilePropertiesOpen && (
                                                <div className="flex flex-col gap-1 pl-4 mt-1 mb-2 bg-gray-50/50 dark:bg-gray-800/20 rounded-lg p-2">
                                                    {/* Sale Section */}
                                                    ...
                                                    {propertyMenuItems.sale.map((item) => (
                                                        <Link
                                                            key={item.label}
                                                            href={item.href}
                                                            className="px-4 py-2.5 rounded-md text-xs font-medium text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                                                        >
                                                            {item.label}
                                                        </Link>
                                                    ))}
