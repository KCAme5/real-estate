...
export default function WhyChooseUs() {
    ...
    return (
        <section className="py-24 bg-background relative overflow-hidden">
            <div className="absolute bottom-0 right-0 translate-y-1/2 translate-x-1/2 w-96 h-96 bg-primary/10 rounded-full blur-3xl"></div>
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="group text-center p-8 rounded-2xl bg-card border border-border hover:border-primary/50 transition-all duration-300 shadow-lg hover:shadow-[0_0_20px_rgba(16,185,129,0.15)] hover:-translate-y-2 relative overflow-hidden"
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>

                            {/* Icon */}
                            <div className="w-24 h-24 bg-muted text-primary rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-md border border-border group-hover:scale-110 transition-transform duration-300 relative z-10">
                                {feature.icon}
                            </div>
                            ...
                            {/* Hover Indicator */}
                            <div className="mt-6 w-16 h-1 bg-primary rounded-full mx-auto scale-x-50 group-hover:scale-x-100 transition-transform duration-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]"></div>
                        </div>
                    ))}
                </div>
